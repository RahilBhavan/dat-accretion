...
| 5 | USD Cash first disclosed for 8/23: R jumps $1.59B with no action behind it. | Booked in Step 4 as its own labeled `disclosure` row. | Kept out of the attribution residual. |
