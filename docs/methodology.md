...
| SharpLink R is 2026-06-30 balance-sheet cash, rolled to other dates by filed cash flows. S uses the 10-Q counts for 2026-06-30 and 2026-08-03, rolled by filed issuance and buybacks, plus RSUs and in-the-money warrants. Issue and buyback USD come from the 10-Q equity statement. | Releases state no cash; the 10-Q gives net proceeds and treasury cost. Operating costs and staking revenue are not in R. |
